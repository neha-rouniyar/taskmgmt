...
Route::get('/verify-email/{token}',[AdminController::class,'verifyEmail'])->name('accept.task');
Route::get('/verify-email/{token}',[AdminController::class,'verifyEmail'])->name('reject.task');
