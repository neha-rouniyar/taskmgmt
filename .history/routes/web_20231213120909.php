...
Route::get('/user/accept-task',[AdminController::class,'verifyEmail'])->name('accept.task');
Route::get('/user/accept-task',[AdminController::class,'verifyEmail'])->name('reject.task');
