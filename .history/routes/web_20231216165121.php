...
Route::post('/admin/task-assign-submit',[AdminController::class,'taskAssignSubmit'])->name('admin.task.assign.submit');

//assign-task
Route::get('/admin/view-task-assigned',[AdminController::class,'viewTaskAssigned'])->name('admin.view.taskassigned');

Route::get('/admin/edit-task-assigned/{id}',[AdminController::class,'editTaskAssigned'])->name('assignTask.edit');
Route::get('/admin/delete-task-assigned/{id}',[AdminController::class,'deleteTaskAssigned'])->name('assignTask.delete');
Route::post('/admin/update-task-assigned/{id}',[AdminController::class,'updateTaskAssigned'])->name('admin.assign.task.update');
...
Route::get('/user/accept-task/{id}',[AssignTaskController::class,'acceptTask'])->name('accept.task');
Route::get('/user/reject-task/{id}',[AssignTaskController::class,'rejectTask'])->name('reject.task');
Route::get('/user/task-complete/{id}',[AssignTaskController::class,'completeTask'])->name('task.complete');
