...
Route::get('/user/accept-task',[AssignTaskController::class,'verifyEmail'])->name('accept.task');
Route::get('/user/reject-task',[AssignTaskController::class,'verifyEmail'])->name('reject.task');
