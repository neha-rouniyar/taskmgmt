...
<div class="container">
    ...
    <form action="{{ route('admin.assign.task.update') }}" method="POST">
        @csrf
            ...
            <div class="custom-dropdown">
                <select name="task" id="task" class="custom-select">
                    @foreach ($task as $tasks)
                        <option value="{{ $tasks->id }}" @if ($tasks->id == $data->task_id) selected @endif>
                            {{ $tasks->task_heading }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="custom-dropdown">
                <select name="user" id="user" class="custom-select">
                    @foreach ($users as $user)
                        <option value="{{ $user->id }}" @if ($tasks->id == $data->task_id) selected @endif>
                            {{ $user->username }}
                        </option>
                    @endforeach
                </select>
