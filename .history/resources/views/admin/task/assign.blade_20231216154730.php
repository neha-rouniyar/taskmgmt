...
<div class="container">
    ...
    @endif
    <form action="{{route('admin.task.assign.submit')}}" method="POST" class="center-align">
        @csrf
        <div class="form-group">
            <label for="assignee" class="center-align">Select Task</label>
        ...
        <div class="form-group">
            <label for="assignee" class="center-align">Assign To:</label>
            <div class="custom-dropdown">
