...
<div class="container">
  <h1 class="my-custom-heading">Create Task</h1>
  @if (session('success'))
  ...
  @endif
  <form action="{{route('admin.task.submit')}}" method="POST" class="my-custom-form">
      @csrf
      <div class="form-group">
          <label for="exampleInputEmail1" class="my-custom-label">Task Heading</label>
          <input type="text" name="heading" class="form-control my-custom-input" id="exampleInputEmail1" placeholder="Task Heading" required>
      </div>
      <button type="submit" class="btn btn-primary my-custom-btn">Submit</button>
  </form>
