...
<form action="" method="POST">
    @csrf
      <div class="form-group">
        ...
        <input style="width: 50%" type="text" value="" name="heading" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Task Heading" required>
      </div>
