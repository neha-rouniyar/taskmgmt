    ...
    <table class="table mt-4">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <button data-toggle="modal" data-target="#exampleModal" style="width: 20%" type="button" class="btn btn-primary">Edit</button>
                <a href=""><button data-toggle="modal" data-target="#exampleModal" style="width: 30%" type="button" class="btn btn-danger">Delete</button></a>
            </td>
          </tr>
          @endif
          @endforeach
