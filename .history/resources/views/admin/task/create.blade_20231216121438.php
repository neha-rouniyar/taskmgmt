    ...
    <table class="table mt-4">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a href="{{route('task.edit',$data->id)}}"><button data-toggle="modal" data-target="#exampleModal" style="width: 20%" type="button" class="btn btn-primary">Edit</button></a>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Task Heading</h5>
