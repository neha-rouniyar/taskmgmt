          ...
          <table class="table mt-4">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>                 
                    {{-- <a href="{{route('accept.task',$assignedTask->id)}}"><button style="width: 30%"  type="button" class="btn btn-primary">Accept</button></a> --}}
                    <a href="{{route('reject.task',$assignedTask->id)}}"> <button style="width: 40%" type="button" class="btn btn-success">Mark as Complete</button></a>
                </td>
              </tr>
              @endif
              @endforeach
