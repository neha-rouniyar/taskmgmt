                    ...
                    @foreach ($user->assignedTasks as $assignedTask)
                        @if ($assignedTask->status==0)
                            <tr>
                                ...
                                <td class="btn-group">
                                    <a href="{{route('accept.task',$assignedTask->id)}}" class="btn btn-primary">Accept</a>
                                    <a href="{{route('reject.task',$assignedTask->id)}}" class="btn btn-danger">Reject</a>
                                </td>
                            </tr>
                        @endif
                    @endforeach
                    ...
                    @foreach ($user->assignedTasks as $assignedTask)
                        @if ($assignedTask->status=='accepted')
                            <tr>
                                ...
                                <td>{{$assignedTask->created_at}}</td>
                                <td>
                                    <a href="{{route('task.complete',$assignedTask->id)}}" class="btn btn-success">Complete</a>
                                </td>
                            </tr>
                        @endif
                    @endforeach
