...
<body>
    <div class="container">
        ...
        @if (session('complete'))
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <p style="color: rgb(20, 216, 20)">{{session('complete')}}</p>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
        ...
        <table class="table mt-4">
            ...
            <tbody>
                @php
                    $i=1;
                @endphp
                @foreach ($user->assignedTasks as $assignedTask)pp
        ...
        <h2 style="text-align: center">Ongoing tasks</h2>
          <table class="table mt-4">
            <thead>
              <tr>
                <th scope="col">S.N</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$assignedTask->created_at}}</td>
                <td>
                    <a href="{{route('task.complete',$assignedTask->id)}}"> <button style="width: 40%" type="button" class="btn btn-success">Mark as Complete</button></a>
                </td>
              </tr>
              @endif
              @endforeach
