...
class LoginController extends Controller
{
   ...
   public function userDashboard(Request $request)
   {
      $user=Auth::user();
      $userId=$user->id;
      $taskAssigned=$user->assignTask;
      dd($taskAssigned);
    //   $assignedTask=$user->assignTask->where('user_id',$userId)->get();
    //   $assignedTask=AssignTask::where('user_id',$userId)->get();
    //   dd($assignedTask);
    //   dd($user->id);
      return view('user.dashboard',compact('user','assignedTask','taskAssigned'));
   }
